...
@Schema(description = "구글 로그인 연동 해제 및 일반 계정 전환 요청 DTO")
public record UnlinkGoogleRequestDTO(

    @Schema(description = "구글 Access Token (또는 OAuth 연동 해제용 토큰)", example = "ya29.a0AfH6SM...")
    @NotBlank(message = "구글 토큰은 필수 입력 항목입니다.")
    String googleToken,
