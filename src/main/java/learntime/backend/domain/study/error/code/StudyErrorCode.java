...
public enum StudyErrorCode implements BaseErrorCode {
    ...
    INVALID_DATE_RANGE(HttpStatus.BAD_REQUEST, "STUDY-002", "종료일은 시작일보다 빠를 수 없습니다."),
    INVALID_STUDY_PERIOD(HttpStatus.BAD_REQUEST, "STUDY-003", "학습 기간은 14일 이상 90일 이하만 가능합니다."),
