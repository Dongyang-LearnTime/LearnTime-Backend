...
public enum StudyErrorCode implements BaseErrorCode {
    ...
    STUDY_DAILY_NOT_FOUND(HttpStatus.NOT_FOUND, "STUDY-002", "공부 일일 진도를 찾을 수 없습니다."),
    INVALID_DATE_RANGE(HttpStatus.BAD_REQUEST, "STUDY-003", "종료일은 시작일보다 빠를 수 없습니다."),
    INVALID_STUDY_PERIOD(HttpStatus.BAD_REQUEST, "STUDY-004", "학습 기간은 14일 이상 90일 이하만 가능합니다."),
    STUDY_SAVE_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "STUDY-005", "학습 계획을 저장하는 도중 데이터베이스 오류가 발생했습니다."),
